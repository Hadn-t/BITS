...
const NearbyHospitals = () => {
  ...
  const renderHospitalCard = ({ item }) => {
    const getButtonStyle = (infoAvailable) => ({
      ...styles.actionButton,
      backgroundColor: infoAvailable ? '#28a745' : '#e74c3c',
    });
    ...
    return (
      ...
      >
        ...
        <View style={styles.actionButtons}>
          ...
          <TouchableOpacity
            style={getButtonStyle(true)}  // Always enable Directions button
...
//   // Render individual hospital card
//   const renderHospitalCard = ({ item }) => {
//     const phoneAvailable = item.phone !== 'Not available';
//     const websiteAvailable = item.website !== 'Not available';
//     const directionAvailable = item.lat && item.lon;
...
//         <View style={styles.actionButtons}>
//           <TouchableOpacity
//             style={[styles.actionButton, { backgroundColor: phoneAvailable ? '#4CAF50' : '#F44336' }]}
//             onPress={() => makePhoneCall(item.phone)}
//           >
//             <MaterialIcons name="phone" size={20} color="#fff" />
//             <Text style={styles.buttonText}>Call</Text>
...
//           <TouchableOpacity
//             style={[styles.actionButton, { backgroundColor: websiteAvailable ? '#4CAF50' : '#F44336' }]}
//             onPress={() => openWebsite(item.website)}
//           >
//             <MaterialIcons name="web" size={20} color="#fff" />
//             <Text style={styles.buttonText}>Website</Text>
...
//           <TouchableOpacity
//             style={[styles.actionButton, { backgroundColor: directionAvailable ? '#4CAF50' : '#F44336' }]}
//             onPress={() => openDirections(item)}
//           >
//             <MaterialIcons name="directions" size={20} color="#fff" />
//             <Text style={styles.buttonText}>Directions</Text>
